...
ns.RegisterPoints(100, {
    [54974889]={label="Hellfire Citadel -> Magtheridon's Lair", link={534, 49575070}},
...
ns.RegisterPoints(102, {
    [49195538]={label="North-East Nagrand Coast -> Twinspire Ruins", link={550, 81130898}},
    [68208847]={label="Nagrand Border -> Entrance to Nagrand", link={550, 88352284}},
    [82616614]={label="Path of Glory -> Zangarmarsh Border", link={535, 68400932}},
}, mirror)
ns.RegisterPoints(104, {
    [27123336]={label="Moonflower Valley -> Legion Hold", link={539, 32312876}},
    [61544606]={label="Path of Light -> The Warden's Cage", link={539, 60004838}},
}, mirror)
ns.RegisterPoints(105, {
    [39657740]={label="Gormaul Tower -> Bloodmaul Ravine", link={525, 37506070}},
    [46416405]={label="Burning Glacier -> Bloodmaul Ravine", link={525, 21814530}},
    [59137171]={label="Razor Bloom -> Razor Ridge", link={543, 49407367}},
    [66212635]={label="Blackrock Foundry -> Gruul's Lair", link={543, 50823142}},
}, mirror)
ns.RegisterPoints(107, {
    [41285903]={label="Oshugun Spirit Woods -> Oshugun Spirit Fields", link={550, 50325722}},
...
ns.RegisterPoints(108, {
    ...
    [45364754]={label="Deathweb Hollow -> Bone Wastes", link={535, 57848052}},
    [70787587]={label="Talador Border -> Skettis", link={542, 47391246}},
}, mirror)
ns.RegisterPoints(525, {
    [21814530]={label="Bloodmaul Ravine -> Burning Glacier", link={105, 46416405}},
    [37506070]={label="Bloodmaul Ravine -> Gormaul Tower", link={105, 39657740}},
}, mirror)
ns.RegisterPoints(534, {
    [49575070]={label="Magtheridon's Lair -> Hellfire Citadel", link={100, 54974889}},
...
ns.RegisterPoints(535, {
    ...
    [57848052]={label="Bone Wastes -> Deathweb Hollow", link={108, 45364754}},
    [68400932]={label="Zangarmarsh Border -> Path of Glory", link={102, 82616614}},
}, mirror)
ns.RegisterPoints(539, {
    [32312876]={label="Legion Hold -> Moonflower Valley", link={104, 27123336}},
    [60004838]={label="The Warden's Cage -> Path of Light", link={104, 61544606}},
}, mirror)
ns.RegisterPoints(542, {
    [47391246]={label="Skettis -> Talador Border", link={108, 70787587}},
}, mirror)
ns.RegisterPoints(543, {
    [49407367]={label="Razor Ridge -> Razor Bloom", link={105, 59137171}},
    [50823142]={label="Gruul's Lair -> Blackrock Foundry", link={105, 66212635}},
}, mirror)
ns.RegisterPoints(550, {
    [50325722]={label="Oshugun Spirit Fields -> Oshugun Spirit Woods", link={107, 41285903}},
    [71402192]={label="Throne of the Elements -> Throne of the Elements", link={107, 60382556}},
    [81130898]={label="Twinspire Ruins -> North-East Nagrand Coast", link={102, 49195538}},
    [88352284]={label="Entrance to Nagrand -> Nagrand Border", link={102, 68208847}},
}, mirror)
